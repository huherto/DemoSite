...
public class AppConfig {
    ...
    private JndiDataSourceLookup lookupJndi = new JndiDataSourceLookup();
	...
	public ListFactoryBean blMergedPersistenceXmlLocations() {
		...
		List list = Arrays.asList("classpath*:/META-INF/persistence.xml");
...
*/
	...
	public ListFactoryBean blMergedEntityContexts() {
		@SuppressWarnings("rawtypes")
		List list = Arrays.asList("classpath*:applicationContext-entity.xml");
		ListFactoryBean bean =new ListFactoryBean();
		bean.setSourceList(list);
		return bean;
	}
/*
    ...
    */
	...
	public ListFactoryBean blMergedCacheConfigLocations() {
		@SuppressWarnings("rawtypes")
		List list = Arrays.asList("classpath:bl-override-ehcache.xml");
		ListFactoryBean bean =new ListFactoryBean();
		bean.setSourceList(list);
		return bean;
	}
